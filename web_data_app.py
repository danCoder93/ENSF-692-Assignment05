...
def book_data():
    ...
    return render_template(template_name_or_list='template.html', tables=[book_data.to_html(classes='data')], titles=book_data.columns.values)

@app.route("/learn")
def learn():
    # Return a string the describes one thing you learned in ENSF 692.
    return "I learned to do data analysis in python using numpy and pandas"
